...
* Enable Flex integration capability by manually adding the executable file available in [releases](https://github.com/newrelic/nri-flex/releases) in newly created `bin` folder within the file location `/var/db/newrelic-integrations`  
